    ...
    <div ref={containerRef} className="w-full bg-[#F8F9FD] text-[#1E113F] overflow-hidden">
      ...
      <section className="relative bg-gradient-to-br from-[#4E2F94] via-[#5B3BA8] to-[#6C4AB6] text-white py-20 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden shadow-xl">
        ...
        <div className="relative max-w-5xl mx-auto text-center space-y-6">
          ...
          <div className="gsap-team-hero inline-flex items-center gap-2 p-1.5 px-5 rounded-full bg-white/10 border border-white/20 backdrop-blur-md shadow-inner">
            <Users className="w-4 h-4 text-[#FFD1DE]" />
          ...
          <p className="gsap-team-hero text-base sm:text-xl text-purple-100/90 font-light max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="gsap-team-hero grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 max-w-4xl mx-auto">
            <div className="p-4 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md">
              ...
              <p className="text-xs text-purple-200 mt-1">Board Directors</p>
            </div>
            <div className="p-4 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md">
              <span className="text-2xl sm:text-3xl font-black text-white">3</span>
              <p className="text-xs text-purple-200 mt-1">Global Delivery Hubs</p>
            </div>
            <div className="p-4 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md">
              <span className="text-2xl sm:text-3xl font-black text-white">49+</span>
              <p className="text-xs text-purple-200 mt-1">Certified Specialists</p>
            </div>
            <div className="p-4 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md">
              <span className="text-2xl sm:text-3xl font-black text-white">100%</span>
              <p className="text-xs text-purple-200 mt-1">Agile Delivery</p>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {filteredMembers.map((member) => (
            <div
              key={member.id}
              className="animate-fade-in-up card-hover-lift bg-white rounded-3xl border border-gray-200/80 hover:border-[#6C4AB6]/60 shadow-md hover:shadow-2xl transition-all duration-300 flex flex-col justify-between overflow-hidden group"
            >
              <div>
                
                {/* Photo Frame Container */}
                <div className="relative aspect-[4/4] bg-gradient-to-br from-[#2D1B54] via-[#4E2F94] to-[#6C4AB6] overflow-hidden">
                  ...
                  {member.image ? (
                    ...
                    <div className="w-full h-full p-6 flex flex-col items-center justify-center relative">
                      ...
                      <div className="absolute -top-12 -right-12 w-32 h-32 bg-[#EC1557]/30 rounded-full blur-xl pointer-events-none"></div>
                  ...
                  <div className="absolute bottom-3 left-3 bg-black/60 backdrop-blur-md border border-white/20 px-3 py-1 rounded-full text-[11px] font-medium text-white flex items-center gap-1.5 shadow-md">
                    <MapPin className="w-3 h-3 text-[#EC1557]" />
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-extrabold text-[#2D1B54] group-hover:text-[#EC1557] transition-colors leading-snug">
                      {member.name}
                    </h3>
                    <p className="text-xs font-bold uppercase tracking-wider text-[#6C4AB6] mt-1">
                      {member.role}
                    </p>
                  </div>
                  ...
                  <div className="space-y-1.5 pt-2 border-t border-gray-100">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {member.expertise.map((exp, eIdx) => (
                        <span 
                          key={eIdx}
                          className="text-[10px] font-semibold px-2 py-0.5 rounded-md bg-[#F8F9FD] border border-gray-200 text-gray-700"
                        >
                          {exp}
                        </span>
                      ))}
      ...
      <section className="py-16 bg-[#2D1B54] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Hub 1: London */}
            <div className="p-7 rounded-3xl bg-white/5 border border-white/15 space-y-4 hover:bg-white/10 transition-all">
              ...
              <h3 className="text-xl font-bold">London, United Kingdom</h3>
            ...
            <div className="p-7 rounded-3xl bg-white/5 border border-white/15 space-y-4 hover:bg-white/10 transition-all">
              <div className="flex items-center justify-between">
                <span className="text-3xl">🇮🇳</span>
                <span className="text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full bg-[#EC1557]/20 text-[#FFD1DE] border border-[#EC1557]/30">
                  Engineering Center
                </span>
              </div>
              <h3 className="text-xl font-bold">Coimbatore, India</h3>
              <p className="text-xs text-purple-100/80 leading-relaxed">
